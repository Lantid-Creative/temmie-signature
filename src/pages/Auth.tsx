...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex">
      ...
      {/* Right Side - Branding */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-secondary to-muted items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          ...
          >
            {['Premium Quality', 'Fast Delivery', 'Expert Support'].map((item, i) => (
              <div key={i} className="p-4 bg-background/50 backdrop-blur-sm rounded-lg">
